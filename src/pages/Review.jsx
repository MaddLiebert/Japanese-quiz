...
export function Review() {
  const { weakItems, recordAnswer } = useItemProgress();
  ...
  const globalWeakCharacters = weakItems
    .map(id => allData.find(item => item.id === id))
    .filter(Boolean);

  const currentWeakChar = sessionQueue[currentIndex];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-8 py-12 sm:py-20 min-h-screen">
        <header className="mb-8 sm:mb-12 border-b-[4px] border-sumi pb-6 sm:pb-8 relative">
          ...
          <h1 className="text-4xl sm:text-7xl font-serif font-black text-sumi tracking-tighter relative z-10 flex flex-wrap items-center gap-3 sm:gap-4">
            ...
            <span className="bg-shu text-kinari-light text-xl sm:text-2xl px-3 sm:px-4 py-0.5 sm:py-1 rounded-full shadow-sm ml-1 sm:ml-2 mt-1 sm:mt-2">{globalWeakCharacters.length}</span>
          </h1>
        ...
        <div className="bg-kinari p-8 sm:p-12 border-[4px] border-sumi shadow-[8px_8px_0_0_#1a1a1a] mb-16 relative">
          ...
          <div className="flex flex-wrap gap-4 relative z-10">
            {globalWeakCharacters.map((item, idx) => (
        ...
        <div className="flex justify-center">
          <Button
            onClick={() => {
              setSessionQueue(shuffle(globalWeakCharacters)); // Di-shuffle sempurna!
              setCurrentIndex(0);
              setIsReviewing(true);
            }}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-8 py-12 sm:py-20 min-h-screen flex flex-col relative">
        ...
        <div className="flex-1 flex flex-col items-center justify-center relative z-10 pb-16">
          ...
          {isAnswered && !isKana && (
            ...
            >
              <div className={`w-full mb-4 py-3 text-center font-bold text-sm uppercase tracking-widest border-[3px] ${isCorrect
